...
def clear():
    ...
    print(logo)
    print(22*f'{Q} -')
    print(f' {dt} CODER    : MD SIFAT ')
    print(f' {dt} Facebook : MD SIFAT ')
    print(f' {dt} Github   : S1F4T')
    print(22*' -')
#-------line-------------#
def line():
    print(22*' -')
...
def menu():
  ...
  if user in ['01', '1']:
    ...
    os.system('xdg-open https://www.facebook.com/groups/cswf.helpcenter.003/?ref=share&mibextid=NSMWBT')
  else:
